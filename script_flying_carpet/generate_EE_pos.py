...
if __name__ == "__main__":
    ...
    shortened_length = 0.11
    tcl = [icl[0]-shortened_length, icl[1]-shortened_length, icl[2]-shortened_length, icl[3]-shortened_length, icl[4], icl[5], icl[6], icl[7]]
    Q_list, vert_length, cable_tension = flying_carpet.FKD_time(tcl,10,  flying_carpet.vertices, tol = 1e-6, show_info = 1)
    ...
    pickleFile = "./data_flying_carpet/110mm_centered.pkl"
