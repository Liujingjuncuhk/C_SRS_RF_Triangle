...
if __name__ == "__main__":
    ...
    Q_list, vert_length, cable_tension = flying_carpet.FKD_static(tcl,  flying_carpet.vertices, tol = 1e-6, show_info = True)
    ...
    pickleFile = "./data_flying_carpet/60mm_centered.pkl"
